    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-orange-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          <BrandMark stacked className="items-center mb-4" subtitle="Admin access" />
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Admin Login</h1>
          <p className="text-gray-600">Manage Joules Events operations, users, payments, and live registrations.</p>
        </div>
